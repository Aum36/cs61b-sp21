...
public class AddConstantTest {
    ...
    public void testAddConstantOne() {
        ...
        if (lst != null) assertEquals("2 -> 3 -> 4 -> 5 -> 6", lst.toString());
    }
    ...
    public void testAddConstantTwo() {
        ...
        if (lst != null) assertEquals("3 -> 4 -> 5 -> 6 -> 7", lst.toString());
    }
    ...
    public void testAddToLargeList() {
        ...
        if (lst != null) assertEquals("11 -> 12 -> 13 -> 14 -> 15 -> 16 -> 17 -> 18 -> 19", lst.toString());
    }
}
